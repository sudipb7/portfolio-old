  ...
  return (
    <section className="max-w-[700px] mx-auto mt-4 p-4">
      ...
      <Link
        ...
        className="w-fit py-2 px-6 mt-6 rounded-lg text-[15px] md:text-[17px] border-[0.5px] border-zinc-800 flex items-center bg-[#1C1C1C]/90 hover:bg-zinc-900 transition-all"
      >
